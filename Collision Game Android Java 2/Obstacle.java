...
public class Obstacle implements GameObject {
    ...
    public Obstacle(int rectangle_height, int start_x, int start_y, int player_gap, int color) {
        ...
        this.m_right_rectangle = new Rect(start_x + player_gap, start_y, Constants.SCREEN_WIDTH, start_y + rectangle_height);
        this.m_color = color;
    ...
    public boolean playerCollision(Player player) {
        Rect player_shape = player.getPlayerShape();
        boolean left_collision_detected = player_shape.intersect(this.m_left_rectangle);
        boolean right_collision_detected = player_shape.intersect(this.m_right_rectangle);
