...
public class GameLevel implements Animation {
    ...
    public void addScreenLimitBlocks(BallRemover ballRemover) {
        Block topBlock = new Block(0, this.screenLimitBlock, this.screenWidth, this.screenLimitBlock);
    ...
    public void initialize() {
        ...
        Rectangle livesRect = new Rectangle(0, 0, this.screenWidth / 3, this.screenLimitBlock);
        Rectangle scoreRect = new Rectangle(this.screenWidth / 3, 0, this.screenWidth / 3, this.screenLimitBlock);
        Rectangle levelNameRect = new Rectangle((2 * this.screenWidth / 3) - 10, 0, 10 + this.screenWidth / 3,
                this.screenLimitBlock);
    ...
    public void doOneFrame(DrawSurface d) {
        ...
        if (this.getKeyBoard().isPressed("p")) {
            this.runner.run(new PauseScreen(this.getKeyBoard(), this.sprites));
        }
    }
