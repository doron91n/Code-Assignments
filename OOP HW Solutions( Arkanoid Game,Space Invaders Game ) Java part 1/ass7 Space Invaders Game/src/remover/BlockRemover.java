...
public class BlockRemover implements HitListener {
    ...
    private Counter blocksLeftToClear;
    ...
    public void hitEvent(Block beingHit, Ball hitter) {
        if (beingHit.getHitPoints() == 0) {
            ...
            if (beingHit.getCountHit()) {
                this.remainingBlocksNum.decrease(1);
                this.blocksLeftToClear.decrease(1);
                this.removedBlocksNum.increase(1);
            }
        }
    }
}
