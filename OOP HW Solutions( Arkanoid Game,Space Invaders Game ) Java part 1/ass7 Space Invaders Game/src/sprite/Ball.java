...
public class Ball implements Sprite, HitNotifier {
    ...
    /**
     * changes the ball center Point to given point p.
     *
     * @param p - the new center for the ball.
     */
    public void setCenterP(Point p) {
        this.centerP = p;
    }
    ...
    public Line getTrajectory() {
        double x = getCenterP().getX();
        double y = getCenterP().getY();
    ...
    /**
     * @return the game level this ball belong to.
     */
    ...
    public void timePassed(double dt) {
        if (!this.changedSpeed) {
            setVelocity(getVelocity().getDx() * dt, getVelocity().getDy() * dt);
