    ...
    public class ImageServiceModal : IImageServiceModal
    {
        ...
        public string AddFile(string originalPath, out bool result)
        {
            ...
            if(File.Exists(originalPath)) {
                ...
                {
                    result = false;
                    return "Error: Failed creating directories requierd for the new file. Error thrown: " + e.Message;
                }
                // create and save images in their destenation folders
                this.createImages(originalPath, outPutNewPath, thumbNewPath, out message);
            ...
            // sends erorr if file wasn`t found
            result = false;
            return "Error: adding file failed , file not found.";
        }
        ...
        {
            message = "Erorr: failed to extract thumbnail from image";
            // extract the image file extention
            string fileExtension = Path.GetExtension(outNewPath);
